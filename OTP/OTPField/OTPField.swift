...
final public class OTPField : UITextField {
    //MARK:- Basic
    ...
    public var animationType: OTPAnimationTypes = .none
    //MARK:- UnderlineViews
    ...
    //MARK:- Call Back
    public weak var otpDelegete: OTPFieldDelegete?
    //MARK:- Internal
    ...
    public func build() {
        ...
        guard self.slotCount <= 6 else {
            print("OTPField can't work with more than 6 slots.")
            return
        }
