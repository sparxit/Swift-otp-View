...
internal class OTPFieldBuilder {
    //MARK:- Basic
    ...
    private var animationType: OTPAnimationTypes = .none
    ...
    //MARK:- Animation
    public func setAnimationType(type:OTPAnimationTypes) {
